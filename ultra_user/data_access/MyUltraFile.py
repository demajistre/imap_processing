...
def L1Bde(repointNum, version='Latest', sensor='90', rootDir='data/imap') -> MyUltraFile:
    descriptor = 'de'
...
def L1Bstatus(repointNum, version='Latest', sensor='90', rootDir='data/imap')-> MyUltraFile:
    descriptor = 'status'
    return MyUltraFile('l1b', descriptor, repointNum, version=version, sensor=sensor, rootDir=rootDir)